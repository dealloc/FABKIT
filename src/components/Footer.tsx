...
export function Footer() {
	return (
		<footer className="sticky top-[100vh] z-10 border-t border-t-primary pt-3 lg:pl-72 dark:bg-dark">
			<div className="mx-auto max-w-7xl px-6 pb-5 md:flex md:items-center md:justify-between lg:px-8">
				...
				<div>
					<p className="mt-8 text-left text-sm/6 text-primary md:order-1 md:mt-0">
						FABKIT is in no way affiliated with Legend Story Studios. Legend
						...
						art are property of Legend Story Studios. Card Images © Legend Story
						Studios
					</p>
					<p className="mt-8 text-left text-sm/6 text-primary md:order-1 md:mt-0">
						Developed by Thencros & Lambstream
					</p>
				</div>
			</div>
		</footer>
